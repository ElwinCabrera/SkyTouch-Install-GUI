...
void SoftwareDownloadPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SoftwareDownloadPage *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SoftwareDownloadPage::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SoftwareDownloadPage.data,
    qt_meta_data_SoftwareDownloadPage,
    qt_static_metacall,
    nullptr,
    nullptr
} };
